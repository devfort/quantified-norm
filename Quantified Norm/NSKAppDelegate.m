...
{
    NSArray *data = [[NSKDataManager shared] loadDataFromFile];
    for (NSDictionary *thing in data) {
        if (![thing[@"sent"] boolValue]) {
//            [[NSKDataManager shared] sendDatum:thing[@"datum"] success:<#^(void)success#>]
        }
    }
}
